...
import com.github.saiyan.cache.core.listener.MyRemoveListener;
import com.github.saiyan.cache.core.load.MyCacheLoad;
import com.github.saiyan.cache.core.support.evict.CacheEvicts;
import com.github.saiyan.cache.core.support.listener.slow.CacheSlowListener;
import com.github.saiyan.cache.core.support.load.CacheLoads;
import com.github.saiyan.cache.core.support.map.Maps;
...
public class CacheBsTest {
    ...
    public void configTest() {
        ...
        Assert.assertEquals(2, cache.size());
        System.out.println(cache.keySet());
        System.out.println("cache.getSkipList().get(\"3\") = " + cache.getSkipList().get("3"));
    }
